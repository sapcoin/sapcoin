...
const QString BITCOIN_IPC_PREFIX("sapcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click sapcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start sapcoin: click-to-pay handler");
    else
...
{
    // clicking on sapcoin: URLs creates FileOpen events on the Mac:
