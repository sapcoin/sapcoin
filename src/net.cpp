...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
		...
		string strDesc = "SAPCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sapcoin.net", "dnsseed.sapcoin.net"},
    {"coinsap.net", "dnsseed.coinsap.net"},
    {"blockchain-tec.net", "dnsseed.blockchain-tec.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"santapaz.org", "dnsseed.santapaz.org"},
	{ NULL, NULL }
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SAPCoin is probably already running."), addrBind.ToString().c_str());
        else
