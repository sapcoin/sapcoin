...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QStringLiteral("Copyright &copy; 2009-YYYY The Bitcoin developers (2016 SAPCoin)"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About SAPCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>SAPCoin</b> version", 0));
